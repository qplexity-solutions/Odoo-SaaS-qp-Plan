...
class account_invoice_line(models.Model):
    ...
    #     for i in self:
    #         if i.product_id:
    #             frm_cur = i.env.company.currency_id
    #             to_cur = i.move_id.currency_id
    #             purchase_price = i.product_id.standard_price
    #             if i.product_uom_id != i.product_id.uom_id:
    #                 purchase_price = i.product_id.uom_id._compute_price(purchase_price, i.product_uom_id)
    #             price = frm_cur._convert(
    #                                     purchase_price, to_cur,
    #                                     i.move_id.company_id or i.env.company,
    #                                     fields.Date.today(), round=False)   
    #             i.purchase_price = price
