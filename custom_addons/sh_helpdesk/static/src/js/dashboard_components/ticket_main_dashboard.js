...
export class TicketDashboardView extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            console.log("\n\n\n...this....",this)
            this.is_helpdesk_manager = await this.user.hasGroup("sh_helpdesk.helpdesk_group_manager");
            this.is_helpdesk_team_leader = await this.user.hasGroup("sh_helpdesk.helpdesk_group_team_leader");
            this.is_helpdesk_support_user = await this.user.hasGroup("sh_helpdesk.helpdesk_group_user");
